...
#define MAX_NUM_OF_BUFBLK_POOL_64   4096
#define MAX_NUM_OF_BUFBLK_POOL_128  4096
#define MAX_NUM_OF_BUFBLK_POOL_256  4096
#define MAX_NUM_OF_BUFBLK_POOL_512  4096
#define MAX_NUM_OF_BUFBLK_POOL_1024 2048
