...
Status GtpServerListCreate(int epfd, int domain, ListHead *sockList, int port, SockHandler handler, void *data);
Status GtpServerListFree(int epfd, ListHead *sockList);

Status GtpDevListCreate(int epfd, int domain, ListHead *sockList, SockHandler handler, void *data);
